...
type TracksuitCommand struct {
	GitHub struct {
		...
		Repositories []string `long:"repositories" description:"Repositories to sync. Can be repeated to sync many repositories. If multiple values, seperate with a semicolon. If omitted, all repositories are synced."`
